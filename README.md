...
- `dependencies` - A dependency layer is strictly a package that contains third-party dependencies for your Lambda functions.
...
```bash
aws cloudformation delete-stack --stack-name sample-test
```
